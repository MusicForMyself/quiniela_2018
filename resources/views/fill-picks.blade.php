            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-6">
                    ...
                    <form id="fillPicksForm" class="formComponent full" method="POST" action="{{ url("{$agency}/fill-picks") }}">
                        ...
                        <section class="match">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <select name="prop_1_1" id="prop_1_1" class="full-width">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <select name="prop_1_2" id="prop_1_2" class="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <select name="prop_1_3" id="prop_1_3" class="">
                                        <option value="0">0</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                        ...
                        <section class="match">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <select name="prop_2_1" id="prop_2_1" class="full-width">
                                        <option value="21">No habrá anotador</option>
                                        <option value="0">Edson Álvarez </option>
                                        <option value="1">Hugo Ayala </option>
                                        <option value="2">Jesús Gallardo</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <select name="prop_2_2" id="prop_2_2" class="">
                                        <option value="0">0</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <select name="prop_2_3" id="prop_2_3" class="">
                                        <option value="0">0</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                        ...
                        <input class="btn btn-default register-button" type="submit" value="Registrar">
